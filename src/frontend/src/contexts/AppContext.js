...
export const AppProvider = ({ children }) => {
  ...
  // Initialize app data - ONLY after authentication
  // Removed automatic initialization to prevent 401 errors
  // Now called manually by AuthContext after successful login
  ...
  const value = {
    ...
    clearError,
    loadDashboardStats,
    initializeApp  // Export for AuthContext to call after login
  };
