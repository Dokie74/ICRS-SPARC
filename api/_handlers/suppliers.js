...
async function handler(req, res) {
  ...
  try {
    if (req.method === 'GET') {
      ...
      let options = {
        select: 'id, name, contact_person, contact_email, phone, country, created_at, updated_at, address, supplier_type, ein', // Removed supplier_code (doesn't exist), changed email → contact_email
